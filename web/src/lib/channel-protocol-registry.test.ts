...
describe("channel protocol registry", () => {
    ...
    it("keeps strict protocol paths and request contracts isolated", () => {
        ...
        expect(channelProtocolDefinition("sub2api").operations.image).toMatchObject({ createPath: "/images/generations", editPath: "/images/edits", referenceRule: expect.stringContaining("mask.image_url") });
